    ...
    <div>
      <Contanier>
        <div className="md:flex justify-between">
          <div className="logo"> <img src="../images/img.png" alt="logo" /></div>
          <div className="home">
            <ul className="flex gap-4 ">
              {Items.map((i:any) =>{
                return(
                  <div key={i.name}>
                    {i.ss}
                    <div className="flex justify-center text-[18px]">{i.icon}</div>
        ...
        <div className="flex justify-end px-10 items-center gap-4 mt-4 sm:mt-0">
          <div>
            <input
          ...
          <div
            className="text-[24px] bg-slate-100 border p-2 rounded shadow-lg"
            onClick={() => setToggle(true)}
          >
            <ImCart />
          </div>
          <Link href="/">
            <div className="text-[24px] bg-slate-100 border p-2 rounded shadow-lg">
              <BiLogInCircle />
            </div>
          </Link>
        </div>
